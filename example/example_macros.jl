...
@on_initial Hsm.Root function (sm::HsmTest)
...
@on_initial :State_S function (sm::HsmTest)
...
@on_event :State_S :Event_I function (sm::HsmTest, arg)
...
@on_initial :State_S1 function (sm::HsmTest)
...
@on_event :State_S1 :Event_F function (sm::HsmTest, arg)
...
@on_event :State_S1 :Event_I function (sm::HsmTest, arg)
    @debug "Handling Event_I in State_S1"
    return Hsm.EventHandled
end

# Event handlers for State_S11
@on_event :State_S11 :Event_D function (sm::HsmTest, arg)
...
@on_event :State_S11 :Event_G function (sm::HsmTest, arg)
    @debug "Handling Event_G in State_S11"
    Hsm.transition!(sm, :State_S211) do
        @debug "Transitioning from State_S11 to State_S211 on Event_G"
    end
end
@on_event :State_S11 :Event_H function (sm::HsmTest, arg)
...
@on_initial :State_S2 function (sm::HsmTest)
...
@on_initial :State_S21 function (sm::HsmTest)
...
@on_event :State_S21 :Event_A function (sm::HsmTest, arg)
...
@on_event :State_S21 :Event_B function (sm::HsmTest, arg)
    @debug "Handling Event_B in State_S21"
    Hsm.transition!(sm, :State_S211) do
        @debug "Transitioning from State_S21 to State_S211 on Event_B"
    end
end
@on_event :State_S21 :Event_G function (sm::HsmTest, arg)
...
@on_event :State_S211 :Event_D function (sm::HsmTest, arg)
    @debug "Handling Event_D in State_S211"
    Hsm.transition!(sm, :State_S21) do
        @debug "Transitioning from State_S211 to State_S21 on Event_D"
    end
end
@on_event :State_S211 :Event_H function (sm::HsmTest, arg)
